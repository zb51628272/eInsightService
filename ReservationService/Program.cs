...
namespace ReservationService
{
    public class Program
    {
        ...
        internal const string ServiceName = "ReservationService";
        private const string ServiceDisplayName = "ESB Demo ReservationService";
        private const string ServiceDescription = "Processes reservation status changes.";
        ...
        {
            var testService = new ReservationService(args.Where(a => a != RunAsServiceFlag).ToArray());
